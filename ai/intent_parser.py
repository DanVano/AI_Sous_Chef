COMMANDS = {
    ...
    "find_recipe": ["find a recipe", "what can i make", "suggest recipe", "what should i cook",
                    "what can i cook today", "got anything with", "suggest a dish", "what’s for dinner"],
    "start_recipe": ["start a recipe", "begin recipe", "cook", "start cooking", "let's get cooking",
                     "begin the recipe", "i'm ready to cook", "start now"],
    "power_search": ["what can i cook with", "what should i cook with", "recipes with", "show recipes with",
                     "what meals can i make with these", "search by ingredients", "recipes using"],
    ...
    "next_step": ["next step", "continue", "go next", "what's next", "what is next", "what’s next",
                  "okay next", "keep going", "what now", "move on", "next part"],
    "previous_step": ["back a step", "previous step", "go back", "last step", "last part",
                      "what did i just miss", "rewind that"],
    "repeat_step": ["repeat step", "say step again", "repeat", "repeat that", "repeat that please",
                    "can you say that again", "say that again", "pardon", "what was that"],
    ...
    "recap_recipe": ["what am i making", "what am i cooking", "what are we making", "remind me what this recipe is",
                     "what am i making again", "what's the recipe"],

    "set_timer": ["set a timer", "start a timer", "timer for", "remind me in", "can you set a timer", "countdown"],

    "add_shopping": ["add to shopping list", "add to list", "shopping list", "shopping list add"],
